export default function Sidebar({ user }) {
    return (
        <div className="min-h-full bg-white w-1/6 my-4 shadow-md rounded-lg">
            <div className="pt-8">
            ...
            {user.user?.role === "admin" && (
                <>
                    <ul className="menu menu-horizontal rounded-box mt-6 border-b-2">
                        <li>
                            <a
                                className="tooltip"
                                data-tip="My Account"
                ...
                <>
                    <ul className="menu menu-horizontal rounded-box mt-6 border-b-2">
                        ...
                        <li>
                            <a
                                className="tooltip"
                                data-tip="Konfirmasi Pembayaran"
                                href={route("creator.payments")}
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    className="h-5 w-5"
